<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sach_Theo_TacGia_FromChiTietSach.aspx.cs" Inherits="Sach_Theo_TacGia_FromChiTietSach" %>
        ...
        <table cellpadding="3" cellspacing="0" class="style2">
            <tr>
                <td style="background-color: #CC3300; padding-top: 4px; padding-bottom: 4px;">
                    <asp:Label ID="lbltentacgia" runat="server" Font-Bold="True" Font-Size="17pt" 
                        ForeColor="Yellow"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="text-align: left; background-color: #0099FF; font-size: large; font-weight: bold; color: #FFFFFF; padding-bottom: 4px; padding-top: 4px;">
