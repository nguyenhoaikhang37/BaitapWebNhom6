<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sac_theo_CD_From_ChitietSach.aspx.cs" Inherits="Sac_theo_CD_From_ChitietSach" %>
...
<asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
    ...
    <center>
        ...
        <table cellpadding="3" cellspacing="0" class="style2">
            <tr>
                <td style="background-color: #CC3300; text-align: center; padding-top: 4px; padding-bottom: 4px;">
                    <asp:Label ID="lbltencd" runat="server" Font-Bold="True" Font-Size="17pt" 
                        ForeColor="Yellow"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="background-color: #0099FF; text-align: left; font-size: large; font-weight: bold; color: #FFFFFF; padding-top: 4px; padding-bottom: 4px;">
            ...
            <tr>
                <td>
                    <asp:DataList ID="DataList1" runat="server" BackColor="#FFFFCC" 
                        RepeatColumns="2" Width="100%" ShowFooter="False" ShowHeader="False">
                        <ItemTemplate>
                            <table cellpadding="3" cellspacing="0" class="style1">
                                <tr>
                                    ...
                                    <td style="text-align: left; padding-left: 8px">
                                        <asp:HyperLink ID="hpl_ten_sach" runat="server" 
                                ...
                                <tr>
                                    <td style="text-align: left; padding-left: 8px; padding-bottom: 30px;">
