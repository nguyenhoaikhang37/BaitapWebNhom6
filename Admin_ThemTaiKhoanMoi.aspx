<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Admin_ThemTaiKhoanMoi.aspx.cs" Inherits="Admin_ThemTaiKhoanMoi" %>
...
<asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
    ...
    <center>
        ...
        <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#6699FF" 
            Text="THÊM TÀI KHỎAN MỚI"></asp:Label>
        <br />
            ...
            <tr>
                <td style="text-align: right; padding-right: 8px; width: 50%">
                    <asp:Label ID="Label11" runat="server" Font-Bold="True" 
                        Text="Quyền Tài Khỏan"></asp:Label>
                </td>
                <td style="text-align: left; padding-left: 8px; padding-top: 5px; padding-bottom: 5px;">
